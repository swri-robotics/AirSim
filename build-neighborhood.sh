...
# Update Neighborhood project
Unreal/Environments/Neighborhood/clean.sh
mkdir -p Unreal/Environments/Neighborhood/Plugins
rsync -a --delete Unreal/Plugins/AirSim Unreal/Environments/Neighborhood/Plugins
...
echo "=================================================================="
echo "If you are using Neighborhood environment, its already updated."
