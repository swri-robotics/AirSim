...
unrealRootPath=/home/dbeer/unrealengine
AirSimTestRootPath=/home/dbeer/AirSim/Unreal/Environments/TrackUnreal

gameProjectFile=/home/dbeer/AirSim/Unreal/Environments/TrackUnreal/AirSimTest.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(AirSimTestSource.pri)
include(AirSimTestHeader.pri)
include(AirSimTestConfig.pri)
include(AirSimTestIncludes.pri)
include(AirSimTestDefines.pri)
...
AirSimTest-Linux-Debug.commands = $$build AirSimTest Linux Debug  -project="\"$$gameProjectFile\"" $$args
AirSimTest-Linux-DebugGame.commands = $$build AirSimTest Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AirSimTest-Linux-Shipping.commands = $$build AirSimTest Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AirSimTest-Linux-Test.commands = $$build AirSimTest Linux Test  -project="\"$$gameProjectFile\"" $$args
AirSimTest.commands = $$build AirSimTest Linux Development  -project="\"$$gameProjectFile\"" $$args

AirSimTestEditor-Linux-Debug.commands = $$build AirSimTestEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
AirSimTestEditor-Linux-DebugGame.commands = $$build AirSimTestEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AirSimTestEditor-Linux-Shipping.commands = $$build AirSimTestEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AirSimTestEditor-Linux-Test.commands = $$build AirSimTestEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
AirSimTestEditor.commands = $$build AirSimTestEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	AirSimTest-Linux-Debug \
	AirSimTest-Linux-DebugGame \
	AirSimTest-Linux-Shipping \
	AirSimTest-Linux-Test \
	AirSimTest \
	AirSimTestEditor-Linux-Debug \
	AirSimTestEditor-Linux-DebugGame \
	AirSimTestEditor-Linux-Shipping \
	AirSimTestEditor-Linux-Test \
	AirSimTestEditor \
